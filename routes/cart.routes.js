...
router.delete('/', auth, cartController.clearUserCart); // Not yet implemented

// Admin routes - MUST BE ABOVE /:userId TO AVOID COLLISION
...
// This must come last to prevent catching /admin/all etc.
